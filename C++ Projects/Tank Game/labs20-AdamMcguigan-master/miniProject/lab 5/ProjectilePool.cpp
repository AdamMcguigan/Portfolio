...
////////////////////////////////////////////////////////////
void ProjectilePool::update(double dt, std::function<void(int)>& t_funcApplyDamage, sf::Sprite t_tankBase, std::vector<sf::Sprite> & wallSprites)
{	
	...
	for (int i = 0; i < s_POOL_SIZE; i++)
	{
		...
		if( !m_projectiles.at(i).update(dt, t_funcApplyDamage, t_tankBase, wallSprites))
		{
