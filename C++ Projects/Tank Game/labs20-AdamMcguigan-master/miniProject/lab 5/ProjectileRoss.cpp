...
////////////////////////////////////////////////////////////
bool Projectile::update(double dt, std::function<void(int)>& t_funcApplyDamage, sf::Sprite t_tankBase, std::vector<sf::Sprite>& wallSprites)
{
	if (!inUse())
	{
	...
	else 
	{
		...
		{
			std::cout << "collided with tank - Bullet" << std::endl;
			t_funcApplyDamage(1);
		}
	}
