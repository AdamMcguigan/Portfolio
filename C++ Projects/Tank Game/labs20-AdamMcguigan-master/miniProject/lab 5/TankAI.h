...
private:
	...
	/*static const int NUMRAYS = 10;

	sf::VertexArray m_visionCone{ sf::TriangleFan };
	std::array<sf::Vector2f, NUMRAYS> m_visionRayCasts;
	sf::Color visionConePatrolColor = sf::Color::Green;
	sf::Color visionConeFoundPlayerColor = sf::Color::Red;*/
